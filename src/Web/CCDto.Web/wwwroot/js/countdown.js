...
(function ($) {
    function Countdown() {
        ...
        function timerCallBack(a) {
            var b = (a < 1000000000000 ? (d ? (performance.now() + performance.timing.navigationStart) : c()) : a || c());
            if (b - f >= 1000) {
                x._updateTargets();
                f = b
            }
    ...
    $.extend(Countdown.prototype, {
        ...
        _adjustSettings: function (a, b, c) {
            ...
            if (f != null) {
                ...
                var g = ($.isFunction(b.options.serverSync) ? b.options.serverSync.apply(a, [
                ]) : null);
                d = new Date();
                e = (g ? d.getTime() - g.getTime() : 0);
                this._serverSyncs.push([b.options.serverSync,
                e])
            }
        ...
        _generateHTML: function (c) {
            ...
            var n = function (a) {
                ...
                return ((!c.options.significant && h[a]) || (c.options.significant && j[a]) ? '<span class="' + x._sectionClass + '">' + '<span class="' + x._amountClass + '">' + d._translateDigits(c, c._periods[a]) + '</span>' + (b ? b[a] : k[a]) + '</span>' : '')
            };
